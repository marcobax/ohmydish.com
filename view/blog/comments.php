<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="fancy text-center mb-0 with-stripe">Comments on <?php echo $blog['title']; ?></h1>
        </div>
        <div class="col-12">
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <p class="text-center">
                <a href="<?php echo Core::url('blog/' . $blog['slug']); ?>" class="btn btn-warning">Back to the blog</a>
            </p>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <?php if(is_array($comments) && count($comments)): ?>
                <?php foreach($comments as $comment): ?>
                    <?php include(ROOT . 'view/blog/_comment.php'); ?>
                <?php endforeach; ?>
            <?php else: ?>
    ...
    <form action="<?php echo Core::url('blog/comments/' . $blog['slug']); ?>" method="post">
        <div class="row">
            <div class="col-12">
