<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="fancy text-center with-stripe">Privacy statement</h1>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ohmydish, 27 route de la riviere basse, prechac-sur-adour France.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Ohmydish, accessible from <a href="https://ohmydish.com" rel="external nofollow noopener" target="_blank">https://ohmydish.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <p>By email: info@ohmydish.com</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="https://ohmydish.com/contact-us" rel="external nofollow noopener" target="_blank">https://ohmydish.com/contact-us</a></p>
                </li>
                <li>
                    <p>By mail: 27 route de la riviere basse, 32160 Prechac-sur-Adour France</p>
                </li>
            </ul>
        </div>
    </div>
