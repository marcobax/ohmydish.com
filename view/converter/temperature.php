<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="fancy with-stripe mb-0 text-center">Convert temperature</h1>
            <p class="text-center">Reken bijvoorbeeld Celsius om naar Fahrenheit</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12 col-md-8 mb-2">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo Core::url('converter/temperature'); ?>" method="get">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-lg btn-block btn-secondary" href="<?php echo Core::url('converter/temperature'); ?>">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
