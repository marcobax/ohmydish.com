<div class="container-fluid pl-5 pr-5">
    <h3 class="with-stripe">Meest recente zoekopdrachten</h3>
    <div class="row">
        <div class="col-2">
            <form action="<?php echo Core::url('admin/search_index'); ?>" method="get" onsubmit="window.onbeforeunload = null;">
                ...
                <div class="form-group">
                    <label for="status">Suggestion</label>
                ...
                <div class="form-group">
                    <label for="status">Auto suggestion</label>
        ...
        <div class="col-10">
            ...
            <table class="table table-sm table-hover">
                <tr>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'created'); ?>">Aangemaakt</a></th>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'term'); ?>">Zoekterm</a></th>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'total_results'); ?>">Resultaten</a></th>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'page'); ?>">Pagina</a></th>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'suggestion'); ?>">Suggestie</a></th>
                    <th><a href="<?php echo $this->request->filterURI('admin/search_index', 'autosuggest'); ?>">Autosuggestie</a></th>
                    <th>Actie</th>
                </tr>
                <?php foreach($latest_search_terms as $latest_search_term): ?>
                    <tr>
                        ...
                        <td><?php echo $latest_search_term['suggestion']?'Ja':'Nee'; ?></td>
                        <td><?php echo $latest_search_term['autosuggest']?'Ja':'Nee'; ?></td>
                        <td>
